...
namespace Sistem_Penyewaan_Studio_Musik
{
    public partial class FormDashboard : Form
    {
        ...
        {
            // Menampilkan informasi tentang aplikasi ketika logo diklik
            MessageBox.Show("Sistem Penyewaan Studio Musik\nVersi 1.0\n© 2024", "Tentang Aplikasi", MessageBoxButtons.OK, MessageBoxIcon.Information);
        }
